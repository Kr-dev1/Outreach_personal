...
export const metadata: Metadata = {
  title: "LeadForge — Discover Construction Businesses & Manage Outreach",
  description:
    "Find construction and equipment rental businesses, enrich public contact information, and manage outreach from one place.",
};
